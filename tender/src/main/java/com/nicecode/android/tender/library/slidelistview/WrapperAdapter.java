...
abstract class WrapperAdapter implements WrapperListAdapter, ItemMainLayout.OnItemSlideListenerProxy, View.OnClickListener,
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            if (menu == null) {
                throw new IllegalArgumentException("Without this ViewType");
            }
    ...
    /**
     * Setting slide slide open the item location
     *
     * @param position
     */
    protected void setSlideItemPosition(int position) {
        ...
        if (mSlideItemPosition == position) {//he following operations have been performed, and do not go to operate.
            return;
        }
    ...
    /**
     * Get the current slide open the item location
     *
     * @return
     */
    ...
    /**
     * Homing Slide Item Position, button not clickable
     */
